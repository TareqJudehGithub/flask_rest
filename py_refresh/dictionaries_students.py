...
# The values for each must be 'Jose', 'Computing', and a 
# tuple with the values 66, 77, and 88.
student_data = {
  "name": "jose", 
  "school": "computing",
  "grades": (66, 77, 88) 
...
print(average_grade(student_data), end="\n")
...
print(average_grade_all_students(student_data))